...
def parse_args():
    ...
    parser.add_argument("--clip_path", type=str, default="/data/kayoung/repos/projects/SurgVU/VTimeLLM/checkpoints/clip/ViT-L-14.pt")
    parser.add_argument("--pretrain_mm_mlp_adapter", type=str, default="/data/kayoung/repos/projects/SurgVU/VTimeLLM/checkpoints/vtimellm-vicuna-v1-5-7b-stage1/checkpoint-4361/mm_projector.bin")
    parser.add_argument("--stage2", type=str, default="/data/kayoung/repos/projects/SurgVU/VTimeLLM/checkpoints/vtimellm-vicuna-v1-5-7b-stage2/checkpoint-2292")
    parser.add_argument("--stage3", type=str, default="/data/kayoung/repos/projects/SurgVU/VTimeLLM/checkpoints/vtimellm-vicuna-v1-5-7b-stage3/checkpoint-564")
    parser.add_argument("--model_base", type=str, default="/data/kayoung/repos/projects/SurgVU/VTimeLLM/checkpoints/vicuna-7b-v1.5")
    parser.add_argument("--data_path", type=str, default="/data/kayoung/repos/projects/SurgVU/val_2.json")
    parser.add_argument("--feat_folder", type=str, default=None)
    parser.add_argument("--video_folder", type=str, default='/data/dataset/ActivityNet_captions_video/videos/val')
    parser.add_argument("--task", type=str, default='all', choices=['all', 'grounding', 'captioning'])
    parser.add_argument("--log_path", type=str, default='/data/kayoung/repos/projects/SurgVU/VTimeLLM/vtimellm/eval_output/eval_log_0812.txt')
...
if __name__ == "__main__":
    ...
    if args.video_folder is not None:
        ...
        video_loader = VideoExtractor(N=30)
