...
class DataArguments:
    ...
    # Random clip sampling options
    random_clip: bool = True                   # 임의 클립 샘플링 사용할지
    min_clip_ratio: float = 0.5                # 클립 길이 하한 (원본의 비율)
    max_clip_ratio: float = 1.0                # 클립 길이 상한 (원본의 비율)
    target_num_frames: int = 30                # 유니폼 샘플링 목표 프레임 수
...
class LazySupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        # placeholder (not used if loading succeeds)
